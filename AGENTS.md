...
- `src/superagent/` holds the Python package and pytest plugin entrypoints.
...
- Respect coverage focus on `src/superagent` (`tool.coverage.run`); adjust configuration instead of skipping logic.
