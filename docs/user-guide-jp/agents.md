...
「自動アクティベーション」とは、Claude Codeがリクエスト内のキーワードとパターンに基づいて適切なコンテキストで動作指示を読み取り、エンゲージすることを意味します。Airis Agentは、Claudeが最適なスペシャリストにルーティングするための動作ガイドラインを提供します。
...
- 使用`Airis Agent install --diagnose`
...
- [GitHub Issues](https://github.com/agiletec-inc/airis-agent/issues)で問題を報告してください[](https://github.com/agiletec-inc/airis-agent/issues)
...
- **[コマンドガイド](https://github.com/khayashi4337/superagent/blob/master/docs/user-guide/commands.md)**- 最適なエージェント調整をトリガーするAiris Agentコマンドをマスターする
...
- **[技術アーキテクチャ](https://github.com/khayashi4337/superagent/blob/master/docs/developer-guide/technical-architecture.md)**- Airis Agent のエージェント システム設計を理解する
