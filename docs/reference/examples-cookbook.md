# Airis Agent Examples Cookbook

**Status**: ✅ **Status: Current** - Comprehensive collection of practical Airis Agent usage examples organized by complexity and domain.

**Focused Recipe Collections**: The Airis Agent Examples Cookbook has been restructured into three focused collections for better usability and progressive learning.
...
- Essential Airis Agent patterns and fundamentals
...
4. **Success**: Can integrate Airis Agent with any development stack

### Phase 4: Expertise (Month 3+)
1. **Architecture**: Design custom integration patterns
2. **Contribution**: Contribute to Airis Agent framework
...
### ✅ Basic Proficiency
- [ ] Can install and configure Airis Agent
...
**Community**:
- [GitHub Discussions](https://github.com/agiletec-inc/airis-agent/discussions) - Community support
- [GitHub Issues](https://github.com/agiletec-inc/airis-agent/issues) - Bug reports and features
...
**Your Journey**: Start with [Basic Examples](./basic-examples.md), progress through [Advanced Workflows](./advanced-workflows.md), and master [Integration Patterns](./integration-patterns.md). Airis Agent grows with you from simple commands to sophisticated development orchestration.
