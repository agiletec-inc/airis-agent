...
- `src/airis_agent/` holds the Python package and pytest plugin entrypoints.
...
- Respect coverage focus on `src/airis_agent` (`tool.coverage.run`); adjust configuration instead of skipping logic.
