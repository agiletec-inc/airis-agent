# Airis Agent developer-guide Index

## Document Navigation Guide

This index provides comprehensive access to all Airis Agent development documentation, organized by topic and skill level for efficient information discovery.
...
**Target Audience**: Anyone wanting to understand or extend Airis Agent  
...
### 🟢 Beginner Path (Understanding Airis Agent)

**Week 1: Foundation**
1. [Architecture Overview](technical-architecture.md#overview) - What Airis Agent is
...
- **Technical Precision**: All examples reflect Airis Agent reality (context files, not software)
...
This comprehensive index reflects the reality of Airis Agent as a context-oriented configuration framework, focusing on practical context file development and Claude Code integration.