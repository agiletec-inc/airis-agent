...
Airis Agent 通过 Serena MCP 服务器提供持久会话管理，实现在 Claude Code 对话中真正的上下文保存和长期项目连续性。
...
**关键要点**：通过 Serena MCP 的会话管理将 Airis Agent 从单次对话帮助转变为持久项目伙伴关系，在所有开发阶段和 Claude Code 对话中维护上下文、决策和学习。