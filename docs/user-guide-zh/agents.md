...
Super Agent 提供了 14 个领域专业智能体，Claude Code 可以调用它们获得专业知识。
...
"自动激活"意味着 Claude Code 读取行为指令，根据您请求中的关键词和模式来调用相应的上下文。Super Agent 提供行为指导原则，Claude 遵循这些原则路由到最合适的专业人员。
...
**社区支持：**
- 在 [GitHub Issues](https://github.com/kazuki/superagent/issues) 报告问题
- 包括预期与实际智能体激活的示例
...
### 基本文档
- **[命令指南](commands.md)** - 掌握触发最优智能体协调的 Super Agent 命令
...
### 开发资源
- **[技术架构](../developer-guide/technical-architecture.md)** - 理解 Super Agent 的智能体系统设计
