# Airis Agent Agents Guide 🤖

Airis Agent provides 16 domain specialist agents that Claude Code can invoke for specialized expertise.
...
"Auto-activation" means Claude Code reads behavioral instructions to engage appropriate contexts based on keywords and patterns in your requests. Airis Agent provides behavioral guidelines that Claude follows to route to the most appropriate specialists.
...
**Expert Support:**  
- Use `Airis Agent install --diagnose`
- See [Diagnostic Reference Guide](../reference/diagnostic-reference.md) for coordination analysis

**Community Support:**
- Report issues at [GitHub Issues](https://github.com/agiletec-inc/airis-agent/issues)
...
- **[Commands Guide](commands.md)** - Master Airis Agent commands that trigger optimal agent coordination
...
- **[Technical Architecture](../developer-guide/technical-architecture.md)** - Understanding Airis Agent's agent system design
