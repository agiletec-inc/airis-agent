...
1. **Update `plugins/airis-agent/commands/pm.md`**:
   ```diff
...
**Action Required**: Update `plugins/airis-agent/commands/pm.md` to remove Serena references and explicitly document file-based memory approach.
