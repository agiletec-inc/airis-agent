...
- ✅ Session Start Protocol rewritten in `plugins/airis-agent/commands/pm.md:67-102`
...
- ✅ 5 complexity levels implemented in `plugins/airis-agent/commands/pm.md:104-119`
...
- **PM Specification**: `plugins/airis-agent/commands/pm.md` (lines 67-793)
